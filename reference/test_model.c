...
void main( int argc, char ** argv ) {
    ...
    uint8_t test1input[32] = "Hello, world!\n";
    test_fail_count += run_one_test(test1input, strlen(test1input), "64867e2441d162615dc2430b6bcb4d3f4b95e4d0db529fca1eece73c077d72d6");
    printf("============= Done test 1 =============\n");

    printf("============= Starting test 2 =============\n");
    uint8_t test2input[32] = {33, 171, 95, 7, 243, 253, 131, 21, 216, 99, 103, 211, 165, 214, 209, 194, 253, 92, 153, 235, 172, 116, 61, 142, 120, 33, 235, 89, 234, 111, 7, 240};
    ...
    uint8_t test3input[32] = {33, 203, 57, 70, 205, 255, 102, 53, 87, 12, 176, 198, 245, 211, 253, 96, 221, 99, 237, 68, 110, 125, 47, 36, 80, 180, 13, 179, 2, 0, 3, 5};
    test_fail_count += run_one_test(
        test3input, 32,
